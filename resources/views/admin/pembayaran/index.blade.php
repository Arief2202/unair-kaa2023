                                ...
                                <td>
                                    ...
                                    @else
                                        <a type="button" class="btn btn-primary"
                                            href="/pembayaran?id_user={{ $user->id }}">
                                            Lihat Bukti Pembayaran
                                        </a>
                                    @endif
                                </td>
                ...
                <div class="modal-header">
                    @if (isset($request->id_user))
                        <h5 class="modal-title" id="exampleModalLabel">Bukti Pembayaran
                            {{ $users->where('id', '=', $request->id_user)->first()->email }}</h5>
                    @endif
                ...
                <div class="modal-body">
                    @if (isset($request->id_user))
                        <div class="d-flex justify-content-center">
                            <img src="{{ env('APP_URL') }}/storage/{{ $users->where('id', '=', $request->id_user)->first()->bukti_pembayaran }}"
                                alt="Bukti Pembayaran" width="80%">
                        </div>
                    @endif
                </div>
